...
public class PlayerCombat : MonoBehaviour
{
   ...
   public void Update()
   {
    ...
    public int AssignCriticalMultiplier()
    {
        ...
        // If im in the range for a critical hit 
        if ( criticalPercentage<currCriticalHitProbability )
        { 
    ...
    public void AddStrength(){ currStrength += 5; }                                 // Increase strength of both attack1 and attack2
